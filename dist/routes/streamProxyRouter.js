 ...
 */
streamProxyRouter.get('/embed-proxy', async (req, res) => {
 ...
 */
streamProxyRouter.get('/hls-relay', async (req, res) => {
 ...
 */
streamProxyRouter.get('/presets', (req, res) => {
    return res.json({
        success: true,
 ...
 */
streamProxyRouter.get('/active-source', (req, res) => {
 ...
 */
streamProxyRouter.post('/validate', (req, res) => {
    const { url } = req.body;
 ...
 */
streamProxyRouter.get('/health', (req, res) => {
    return res.json({
        success: true,
        status: 'ACTIVE',
        teachingSources: cockfightService.getTeachingStreamSources(),
 ...
 */
streamProxyRouter.post('/configure-arena', (req, res) => {
    ...
    if (arenaId && customStreamUrl !== undefined) {
        const updated = cockfightService.setArenaStreamUrl(arenaId, customStreamUrl);
        if (!updated) {
