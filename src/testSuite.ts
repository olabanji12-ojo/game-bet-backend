...
async function runTestSuite() {
  ...
  assert(CONFIG.DELAY_TIERS.TIER_1_STANDARD_SECONDS === 5 || CONFIG.DELAY_TIERS.TIER_1_STANDARD_SECONDS === 8, `DELAY_TIER_1_STANDARD_SECONDS === ${CONFIG.DELAY_TIERS.TIER_1_STANDARD_SECONDS}s`);
